 ...
 * and model. It has two methods runCommand and start which runs the command that the user inputs
 * and starts an interactive session between the system and the user.
 */
