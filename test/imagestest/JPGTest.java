...
public class JPGTest extends AbstractTest {
  ...
  public void inputTestInvalid() throws IOException {
    ...
    ImageInterface actual = ih.loadImage("src/res/JPG/Sample.png");
  }

  @Test
  public void inputTest() throws IOException {
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = ih.loadImage("src/res/JPG/Sample.jpg");
  ...
  public void testHorizontalFlip() throws IOException {
    Operations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.applyHorizontalFlip(ih.loadImage("src/res/JPG/Sample.jpg"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
  ...
  public void testVerticalFlip() throws IOException {
    Operations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.applyVerticalFlip(ih.loadImage("src/res/JPG/Sample.jpg"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
  ...
  public void brightness() throws IOException {
    Operations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.applyBrightness(ih.loadImage("src/res/JPG/Sample.jpg"), 10);
    ImageCopyInterface expected = new ImageCopy(2, 2);
  ...
  public void redComponent() throws IOException {
    Operations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.visualizeRedComponent(ih.loadImage("src/res/JPG/Sample.jpg"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
  ...
  public void blueComponent() throws IOException {
    Operations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.visualizeBlueComponent(ih.loadImage("src/res/JPG/Sample.jpg"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
  ...
  public void greenComponent() throws IOException {
    Operations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.visualizeGreenComponent(ih.loadImage("src/res/JPG/Sample.jpg"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
  ...
  public void valueComponent() throws IOException {
    Operations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.visualizeValue(ih.loadImage("src/res/JPG/Sample.jpg"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
    expected.setPixel(0, 0, new Pixel(51, 51, 51));
    expected.setPixel(1, 0, new Pixel(195, 195, 195));
    expected.setPixel(0, 1, new Pixel(67, 67, 67));
  ...
  public void lumaComponent() throws IOException {
    Operations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.visualizeLuma(ih.loadImage("src/res/JPG/Sample.jpg"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
  ...
  public void intensityComponent() throws IOException {
    Operations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.visualizeIntensity(ih.loadImage("src/res/JPG/Sample.jpg"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
  ...
  public void rgbSplit() throws IOException {
    Operations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actualr = io.visualizeRedComponent(ih.loadImage("src/res/JPG/Sample.jpg"));
    ImageInterface actualg = io.visualizeGreenComponent(ih.loadImage("src/res/JPG/Sample.jpg"));
    ImageInterface actualb = io.visualizeBlueComponent(ih.loadImage("src/res/JPG/Sample.jpg"));
...
//    Operations io = new ImageOperations();
//    ImageFormatHandler ih = new ImageHandler();
//    ImageInterface actual = io.applyBlur(ih.loadImage("src/res/JPG/Sample.jpg"));
//    ImageCopyInterface expected = new ImageCopy(2, 2);
//    expected.setPixel(0, 0, new Pixel(50, 51, 0));
//    expected.setPixel(1, 0, new Pixel(194, 195, 125));
//    expected.setPixel(0, 1, new Pixel(66, 67, 0));
...
//    Operations io = new ImageOperations();
//    ImageFormatHandler ih = new ImageHandler();
//    ImageInterface actual = io.applySharpen(ih.loadImage("src/res/JPG/Sample.jpg"));
//    ImageCopyInterface expected = new ImageCopy(2, 2);
//    expected.setPixel(0, 0, new Pixel(50, 51, 0));
//    expected.setPixel(1, 0, new Pixel(194, 195, 125));
//    expected.setPixel(0, 1, new Pixel(66, 67, 0));
...
//  }
  ...
  public void sepia() throws IOException {
    Operations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.applySepia(ih.loadImage("src/res/JPG/Sample.jpg"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
...
//  }
  ...
  public void testEquals1() throws IOException {
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface one = ih.loadImage("src/res/JPG/Sample.jpg");
  ...
  public void testEquals3() throws IOException {
    ...
    ImageInterface one = ih.loadImage("src/res/JPG/Sample.jpg");
    ImageInterface two = ih.loadImage("src/res/JPG/Sample.jpg");
    ImageInterface three = ih.loadImage("src/res/JPG/Sample.jpg");
    assertTrue(one.equals(two));
