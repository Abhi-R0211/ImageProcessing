...
/**
 * This class tests the image operations on a BMP image file.
 */
public class BMPTest extends AbstractTest {

  @Test
  public void inputTest() throws IOException {
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = ih.loadImage("src/res/BMP/Sample.bmp");
    ImageCopyInterface expected = new ImageCopy(2, 2);
    expected.setPixel(0, 0, new Pixel(255, 0, 0));
    expected.setPixel(1, 0, new Pixel(0, 255, 0));
    expected.setPixel(0, 1, new Pixel(0, 0, 255));
    expected.setPixel(1, 1, new Pixel(255, 255, 0));
  ...
  public void inputTestInvalid() throws IOException {
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = ih.loadImage("src/res/BMP/Sample.png");
  }
  ...
  public void outputTest() throws IOException {
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = ih.loadImage("src/res/BMP/Sample.bmp");
    ih.saveImage(actual, "src/res/BMP/Sample1.bmp", "bmp");
    assertEquals(true, new File("src/res/BMP/Sample1.bmp").exists());
  }
  ...
  public void testHorizontalFlip() throws IOException {
    ...
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.applyHorizontalFlip(ih.loadImage("src/res/BMP/Sample.bmp"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
    expected.setPixel(1, 0, new Pixel(255, 0, 0));
    expected.setPixel(0, 0, new Pixel(0, 255, 0));
    expected.setPixel(1, 1, new Pixel(0, 0, 255));
    expected.setPixel(0, 1, new Pixel(255, 255, 0));
    assertTrue(expected.deepCopyImage().equals(actual));
  }
  ...
  public void testVerticalFlip() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.applyVerticalFlip(ih.loadImage("src/res/BMP/Sample.bmp"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
    expected.setPixel(1, 0, new Pixel(255, 255, 0));
    expected.setPixel(0, 0, new Pixel(0, 0, 255));
    expected.setPixel(1, 1, new Pixel(0, 255, 0));
    expected.setPixel(0, 1, new Pixel(255, 0, 0));
    assertTrue(expected.deepCopyImage().equals(actual));
  }
  ...
  public void brightness() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.applyBrightness(ih.loadImage("src/res/BMP/Sample.bmp"), 10);
    ImageCopyInterface expected = new ImageCopy(2, 2);
    expected.setPixel(1, 0, new Pixel(10, 255, 10));
    expected.setPixel(0, 0, new Pixel(255, 10, 10));
    expected.setPixel(1, 1, new Pixel(255, 255, 10));
    expected.setPixel(0, 1, new Pixel(10, 10, 255));
    assertTrue(expected.deepCopyImage().equals(actual));
  }
  ...
  public void darken() throws IOException {
    ...
    ImageInterface actual = io.applyBrightness(ih.loadImage("src/res/BMP/Sample.bmp"), -10);
    ImageCopyInterface expected = new ImageCopy(2, 2);
    expected.setPixel(1, 0, new Pixel(0, 245, 0));
    expected.setPixel(0, 0, new Pixel(245, 0, 0));
    expected.setPixel(1, 1, new Pixel(245, 245, 0));
    expected.setPixel(0, 1, new Pixel(0, 0, 245));
    assertTrue(expected.deepCopyImage().equals(actual));
  }
  ...
  public void redComponent() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.visualizeRedComponent(ih.loadImage("src/res/BMP/Sample.bmp"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
  ...
  public void blueComponent() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.visualizeBlueComponent(ih.loadImage("src/res/BMP/Sample.bmp"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
  ...
  public void greenComponent() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.visualizeGreenComponent(ih.loadImage("src/res/BMP/Sample.bmp"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
    expected.setPixel(0, 0, new Pixel(0, 0, 0));
  ...
  public void valueComponent() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.visualizeValue(ih.loadImage("src/res/BMP/Sample.bmp"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
    expected.setPixel(0, 0, new Pixel(255, 255, 255));
    expected.setPixel(1, 0, new Pixel(255, 255, 255));
    expected.setPixel(0, 1, new Pixel(255, 255, 255));
  ...
  public void lumaComponent() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.visualizeLuma(ih.loadImage("src/res/BMP/Sample.bmp"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
    expected.setPixel(0, 0, new Pixel(54, 54, 54));
    expected.setPixel(1, 0, new Pixel(182, 182, 182));
    expected.setPixel(0, 1, new Pixel(18, 18, 18));
    expected.setPixel(1, 1, new Pixel(236, 236, 236));
    assertTrue(expected.deepCopyImage().equals(actual));
  }
  ...
  public void intensityComponent() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.visualizeIntensity(ih.loadImage("src/res/BMP/Sample.bmp"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
    expected.setPixel(0, 0, new Pixel(85, 85, 85));
    expected.setPixel(1, 0, new Pixel(85, 85, 85));
    expected.setPixel(0, 1, new Pixel(85, 85, 85));
    expected.setPixel(1, 1, new Pixel(170, 170, 170));
    assertTrue(expected.deepCopyImage().equals(actual));
  }
  ...
  public void rgbSplit() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actualr = io.visualizeRedComponent(ih.loadImage("src/res/BMP/Sample.bmp"));
    ImageInterface actualg = io.visualizeGreenComponent(ih.loadImage("src/res/BMP/Sample.bmp"));
    ImageInterface actualb = io.visualizeBlueComponent(ih.loadImage("src/res/BMP/Sample.bmp"));
    ImageCopyInterface expectedr = new ImageCopy(2, 2);
    expectedr.setPixel(0, 0, new Pixel(255, 255, 255));
    expectedr.setPixel(1, 0, new Pixel(0, 0, 0));
    expectedr.setPixel(0, 1, new Pixel(0, 0, 0));
    expectedr.setPixel(1, 1, new Pixel(255, 255, 255));
    ...
    expectedg.setPixel(1, 0, new Pixel(255, 255, 255));
    ...
    expectedb.setPixel(0, 1, new Pixel(255, 255, 255));
    expectedb.setPixel(1, 1, new Pixel(0, 0, 0));
...
//    ImageOperations io = new ImageOperations();
//    ImageFormatHandler ih = new ImageHandler();
//    ImageInterface actual = io.applyBlur(ih.loadImage("src/res/BMP/Sample.bmp"));
//    ImageCopyInterface expected = new ImageCopy(2, 2);
//    expected.setPixel(0, 0, new Pixel(255, 0, 0));
//    expected.setPixel(1, 0, new Pixel(0, 255, 0));
//    expected.setPixel(0, 1, new Pixel(0, 0, 255));
...
//  }
  ...
  public void sharped() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.applySharpen(ih.loadImage("src/res/BMP/Sample.bmp"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
    expected.setPixel(0, 0, new Pixel(255, 0, 0));
    expected.setPixel(1, 0, new Pixel(0, 255, 0));
    expected.setPixel(0, 1, new Pixel(0, 0, 255));
  ...
  public void sepia() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.applySepia(ih.loadImage("src/res/BMP/Sample.bmp"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
    expected.setPixel(0, 0, new Pixel(100, 88, 69));
    expected.setPixel(1, 0, new Pixel(196, 174, 136));
    expected.setPixel(0, 1, new Pixel(48, 42, 33));
    expected.setPixel(1, 1, new Pixel(255, 255, 205));
    assertTrue(expected.deepCopyImage().equals(actual));
  }
  ...
  public void multipleFunction() throws IOException {
    ...
    ImageCopyInterface expected = new ImageCopy(2, 2);
    expected.setPixel(0, 0, new Pixel(48, 42, 33));
    expected.setPixel(1, 0, new Pixel(255, 255, 205));
    expected.setPixel(0, 1, new Pixel(100, 88, 69));
    expected.setPixel(1, 1, new Pixel(196, 174, 136));
...
//    ImageCopyInterface expected = new ImageCopy(2, 2);
//    expected.setPixel(0, 0, new Pixel(255, 255, 0));
//    expected.setPixel(1, 0, new Pixel(0, 0, 255));
//    expected.setPixel(0, 1, new Pixel(0, 255, 0));
//    expected.setPixel(1, 1, new Pixel(255, 0, 0));
...
//  }
  ...
  public void testEquals1() throws IOException {
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface one = ih.loadImage("src/res/BMP/Sample.bmp");
  ...
  public void testEquals2() throws IOException {
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface one = ih.loadImage("src/res/BMP/Sample.bmp");
    ImageInterface two = ih.loadImage("src/res/BMP/Sample.bmp");
  ...
  public void testEquals3() throws IOException {
    ...
    ImageInterface one = ih.loadImage("src/res/BMP/Sample.bmp");
    ImageInterface two = ih.loadImage("src/res/BMP/Sample.bmp");
    ImageInterface three = ih.loadImage("src/res/BMP/Sample.bmp");
    assertTrue(one.equals(two));
  ...
  public void testEquals4() throws IOException {
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface one = ih.loadImage("src/res/BMP/Sample.bmp");
    ImageInterface two = ih.loadImage("src/res/JPEG/Sample.jpeg");
