...
public class PPMTest extends AbstractTest {
  ...
  public void inputTestInvalid() throws IOException {
    P3PPMHandler ih = new P3PPMHandler();
    Image actual = ih.loadImage("src/res/PPM/Sample.png");
  }

  @Test
  public void inputTest() throws IOException {
    P3PPMHandler ih = new P3PPMHandler();
    Image actual = ih.loadImage("src/res/PPM/sample.ppm");
  ...
  public void outputTest() throws IOException {
    ...
    assertEquals(true, new File("src/res/PPM/Sample1.ppm").exists());
  }
  ...
  public void testHorizontalFlip() throws IOException {
    ...
    P3PPMHandler ih = new P3PPMHandler();
    Image actual = io.applyHorizontalFlip(ih.loadImage("src/res/PPM/sample.ppm"));
    Image expected = new Image(2, 2);
  ...
  public void testVerticalFlip() throws IOException {
    ImageOperations io = new ImageOperations();
    P3PPMHandler ih = new P3PPMHandler();
    Image actual = io.applyVerticalFlip(ih.loadImage("src/res/PPM/sample.ppm"));
    Image expected = new Image(2, 2);
  ...
  public void brightness() throws IOException {
    ImageOperations io = new ImageOperations();
    P3PPMHandler ih = new P3PPMHandler();
    Image actual = io.applyBrightness(ih.loadImage("src/res/PPM/sample.ppm"), 10);
    Image expected = new Image(2, 2);
  ...
  public void redComponent() throws IOException {
    ImageOperations io = new ImageOperations();
    P3PPMHandler ih = new P3PPMHandler();
    Image actual = io.visualizeRedComponent(ih.loadImage("src/res/PPM/sample.ppm"));
    Image expected = new Image(2, 2);
    expected.setPixel(0, 0, new Pixel(0, 0, 0));
  ...
  public void blueComponent() throws IOException {
    ImageOperations io = new ImageOperations();
    P3PPMHandler ih = new P3PPMHandler();
    Image actual = io.visualizeBlueComponent(ih.loadImage("src/res/PPM/sample.ppm"));
    Image expected = new Image(2, 2);
    expected.setPixel(0, 0, new Pixel(0, 0, 0));
    expected.setPixel(1, 0, new Pixel(0, 0, 0));
    expected.setPixel(0, 1, new Pixel(0, 0, 0));
  ...
  public void greenComponent() throws IOException {
    ImageOperations io = new ImageOperations();
    P3PPMHandler ih = new P3PPMHandler();
    Image actual = io.visualizeGreenComponent(ih.loadImage("src/res/PPM/sample.ppm"));
    Image expected = new Image(2, 2);
    expected.setPixel(0, 0, new Pixel(0, 0, 0));
    expected.setPixel(1, 0, new Pixel(0, 0, 0));
    expected.setPixel(0, 1, new Pixel(0, 0, 0));
  ...
  public void valueComponent() throws IOException {
    ImageOperations io = new ImageOperations();
    P3PPMHandler ih = new P3PPMHandler();
    Image actual = io.visualizeValue(ih.loadImage("src/res/PPM/sample.ppm"));
    Image expected = new Image(2, 2);
    expected.setPixel(0, 0, new Pixel(0, 0, 0));
    expected.setPixel(1, 0, new Pixel(100, 100, 100));
    expected.setPixel(0, 1, new Pixel(0, 0, 0));
  ...
  public void lumaComponent() throws IOException {
    ImageOperations io = new ImageOperations();
    P3PPMHandler ih = new P3PPMHandler();
    Image actual = io.visualizeLuma(ih.loadImage("src/res/PPM/sample.ppm"));
    Image expected = new Image(2, 2);
    expected.setPixel(0, 0, new Pixel(0, 0, 0));
  ...
  public void intensityComponent() throws IOException {
    ImageOperations io = new ImageOperations();
    P3PPMHandler ih = new P3PPMHandler();
    Image actual = io.visualizeIntensity(ih.loadImage("src/res/PPM/sample.ppm"));
    Image expected = new Image(2, 2);
    expected.setPixel(0, 0, new Pixel(0, 0, 0));
  ...
  public void rgbSplit() throws IOException {
    ImageOperations io = new ImageOperations();
    P3PPMHandler ih = new P3PPMHandler();
    Image actualr = io.visualizeRedComponent(ih.loadImage("src/res/PPM/sample.ppm"));
    Image actualg = io.visualizeGreenComponent(ih.loadImage("src/res/PPM/sample.ppm"));
    Image actualb = io.visualizeBlueComponent(ih.loadImage("src/res/PPM/sample.ppm"));
  ...
  public void blur() throws IOException {
    ImageOperations io = new ImageOperations();
    P3PPMHandler ih = new P3PPMHandler();
    Image actual = io.applyBlur(ih.loadImage("src/res/PPM/sample.ppm"));
    Image expected = new Image(2, 2);
    expected.setPixel(0, 0, new Pixel(0, 0, 0));
    expected.setPixel(1, 0, new Pixel(100, 0, 0));
    expected.setPixel(0, 1, new Pixel(0, 0, 0));
  ...
  public void sharped() throws IOException {
    ImageOperations io = new ImageOperations();
    P3PPMHandler ih = new P3PPMHandler();
    Image actual = io.applySharpen(ih.loadImage("src/res/PPM/sample.ppm"));
    Image expected = new Image(2, 2);
    expected.setPixel(0, 0, new Pixel(0, 0, 0));
    expected.setPixel(1, 0, new Pixel(100, 0, 0));
    expected.setPixel(0, 1, new Pixel(0, 0, 0));
  ...
  public void sepia() throws IOException {
    ImageOperations io = new ImageOperations();
    P3PPMHandler ih = new P3PPMHandler();
    Image actual = io.applySepia(ih.loadImage("src/res/PPM/sample.ppm"));
    Image expected = new Image(2, 2);
    expected.setPixel(0, 0, new Pixel(0, 0, 0));
  ...
  public void testEquals1() throws IOException {
    P3PPMHandler ih = new P3PPMHandler();
    Image one = ih.loadImage("src/res/PPM/sample.ppm");
  ...
  public void testEquals2() throws IOException {
    P3PPMHandler ih = new P3PPMHandler();
    Image one = ih.loadImage("src/res/PPM/sample.ppm");
    Image two = ih.loadImage("src/res/PPM/sample.ppm");
  ...
  public void testEquals3() throws IOException {
    ...
    Image one = ih.loadImage("src/res/PPM/sample.ppm");
    Image two = ih.loadImage("src/res/PPM/sample.ppm");
    Image three = ih.loadImage("src/res/PPM/sample.ppm");
    assertTrue(one.equals(two));
  ...
  public void testEquals4() throws IOException {
    ...
    Image one = ih.loadImage("src/res/PPM/sample.ppm");
    Image two = ih2.loadImage("src/res/JPG/Sample.jpg");
