...
public class JPEGTest extends AbstractTest {
  ...
  public void inputTest() throws IOException {
    ...
    ImageInterface actual = ih.loadImage("src/res/JPEG/Sample.jpeg");
  ...
  public void inputTestInvalid() throws IOException {
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = ih.loadImage("src/res/JPEG/Sample.png");
  }
  ...
  public void testHorizontalFlip() throws IOException {
    ...
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.applyHorizontalFlip(ih.loadImage("src/res/JPEG/Sample.jpeg"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
  ...
  public void testVerticalFlip() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.applyVerticalFlip(ih.loadImage("src/res/JPEG/Sample.jpeg"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
  ...
  public void brightness() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.applyBrightness(ih.loadImage("src/res/JPEG/Sample.jpeg"), 10);
    ImageCopyInterface expected = new ImageCopy(2, 2);
  ...
  public void redComponent() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.visualizeRedComponent(ih.loadImage("src/res/JPEG/Sample.jpeg"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
  ...
  public void blueComponent() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.visualizeBlueComponent(ih.loadImage("src/res/JPEG/Sample.jpeg"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
  ...
  public void greenComponent() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.visualizeGreenComponent(ih.loadImage("src/res/JPEG/Sample.jpeg"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
  ...
  public void valueComponent() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.visualizeValue(ih.loadImage("src/res/JPEG/Sample.jpeg"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
    expected.setPixel(0, 0, new Pixel(75, 75, 75));
    expected.setPixel(1, 0, new Pixel(176, 176, 176));
    expected.setPixel(0, 1, new Pixel(56, 56, 56));
  ...
  public void lumaComponent() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.visualizeLuma(ih.loadImage("src/res/JPEG/Sample.jpeg"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
  ...
  public void intensityComponent() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.visualizeIntensity(ih.loadImage("src/res/JPEG/Sample.jpeg"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
  ...
  public void rgbSplit() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actualr = io.visualizeRedComponent(ih.loadImage("src/res/JPEG/Sample.jpeg"));
    ImageInterface actualg = io.visualizeGreenComponent(ih.loadImage("src/res/JPEG/Sample.jpeg"));
    ImageInterface actualb = io.visualizeBlueComponent(ih.loadImage("src/res/JPEG/Sample.jpeg"));
...
//    ImageOperations io = new ImageOperations();
//    ImageFormatHandler ih = new ImageHandler();
//    ImageInterface actual = io.applyBlur(ih.loadImage("src/res/JPEG/Sample.jpeg"));
//    ImageCopyInterface expected = new ImageCopy(2, 2);
//    expected.setPixel(0, 0, new Pixel(74, 75, 5));
//    expected.setPixel(1, 0, new Pixel(175, 176, 106));
//    expected.setPixel(0, 1, new Pixel(55, 56, 0));
...
//    ImageOperations io = new ImageOperations();
//    ImageFormatHandler ih = new ImageHandler();
//    ImageInterface actual = io.applySharpen(ih.loadImage("src/res/JPEG/Sample.jpeg"));
//    ImageCopyInterface expected = new ImageCopy(2, 2);
//    expected.setPixel(0, 0, new Pixel(74, 75, 5));
//    expected.setPixel(1, 0, new Pixel(175, 176, 106));
//    expected.setPixel(0, 1, new Pixel(55, 56, 0));
...
//  }
  ...
  public void sepia() throws IOException {
    ImageOperations io = new ImageOperations();
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface actual = io.applySepia(ih.loadImage("src/res/JPEG/Sample.jpeg"));
    ImageCopyInterface expected = new ImageCopy(2, 2);
...
//  }
  ...
  public void testEquals1() throws IOException {
    ImageFormatHandler ih = new ImageHandler();
    ImageInterface one = ih.loadImage("src/res/JPEG/Sample.jpeg");
  ...
  public void testEquals3() throws IOException {
    ...
    ImageInterface one = ih.loadImage("src/res/JPEG/Sample.jpeg");
    ImageInterface two = ih.loadImage("src/res/JPEG/Sample.jpeg");
    ImageInterface three = ih.loadImage("src/res/JPEG/Sample.jpeg");
    assertTrue(one.equals(two));
